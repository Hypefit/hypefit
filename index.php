...
$contenidoPrincipal .= <<<EOS
  <div class="bg-light" id="inicio""></div>
    <!--Rutinas-->
            ...
            <div class="outer container">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 pb-2">
                        <div class="card h-100 border-secondary ms-2 text-center ">
                            <a href="rutinas.php#trenSup">
                                <img class="card-img-top img-cards-index" src="${rutaTrenSup}" alt="Tren Superior">
                            </a>
                            <div class="card-body">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 pb-2">
                        <div class="card h-100 border-secondary ms-2 text-center">
                            <a href="rutinas.php#trenInf">
                                <img class="card-img-top img-cards-index" src="${rutaTrenInf}" alt="Tren Inferior">
                            </a>
                            <div class="card-body">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 pb-2">
                        <div class="card h-100 border-secondary ms-2 text-center">
                            <a href="rutinas.php#fullBody">
                              <img class="card-img-top img-cards-index" src="${rutaFullBody}" alt="Full Body">
                            </a>
                            <div class="card-body">
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="text-center mb-3">
                        <h5>Mantente en forma con nuestras <a class="text-decoration-none" href="rutinas.php">rutinas</a>.</h5>
            ...
            <div class="outer container">
                ...
                <div class="row ps-0 justify-content-center">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3  pb-2">
                        <div class="card h-100 border-dark ms-2 text-center">
                            <a href="recetas.php" >
                                <img class="card-img-top img-cards-index" src="${rutaRecetasNormales}" alt="sin requerimientos">
                            </a>
                            <div class="card-body">
                                <h5 class="card-title text-capitalize text-dark">Dieta sin requerimientos</h5>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 pb-2">
                        <div class="card h-100 border-dark ms-2 text-center">
                            <a href="recetas.php">
                                <img class="card-img-top img-cards-index" src="${rutaRecetasVegetarianas}" alt="Vegetariana">
                            </a>
                            <div class="card-body">
                                <h5 class="card-title text-capitalize text-dark">Dieta vegetariana</h5>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 pb-2">
                        <div class="card h-100 border-dark ms-2 text-center">
                            <a href="recetas.php">
                                <img class="card-img-top img-cards-index" src="${rutaRecetasVeganas}" alt="Vegana">
                            </a>
                            <div class="card-body">
                                <h5 class="card-title text-capitalize text-dark">Dieta vegana</h5>
                ...
                <div class="row align-items-center justify-content-center" >
                    <div class="text-center mb-3">
                        ...
                        <h5>Nuestras <a href="recetas.php" class="text-decoration-none">recetas</a> preparadas por nutricionistas te ayudarán a
