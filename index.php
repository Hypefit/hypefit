...
$contenidoPrincipal = <<<EOS
  <div class="bg-light" id="inicio" style="height: 9%;"></div>
                ...
                <div class="row ps-0 justify-content-center">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 pb-2">
                        <div class="card h-100 border-secondary text-center">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">Tren inferior</h5>
    ...
    <!--Recetas-->
    <div class="container-fluid px-0">
        <div class="recetas row ps-0 me-0 align-items-center justify-content-center"">
            <div class="outer container">
                <!--Rows-->
                ...
                <div class="row ps-0 justify-content-center">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3  pb-2">
                        <div class="card h-100 border-secondary ms-2 text-center">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">Dieta sin requerimientos</h5>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 pb-2">
                        <div class="card h-100 border-secondary ms-2 text-center">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">Dieta vegana</h5>
